...
<h1> Create Players </h1>
    ...
    <form method="post">
        <table border=1 align="center" cellspacing="0" cellpadding="10">
            ...
            <tr>
                <td colspan="2">
                    <button type="submit" name="Insert11"> Create</button>
                </td>
            </tr>
    ...
    if(isset($_POST['Insert11'])) {
        ...
        if(mysqli_num_rows($query) > 0) {
            ...
            $query = mysqli_query($conn, $sql);
        if($query)  {
                echo "<script> alert('Congratulations you have now created all the players'); window.location='Player_list.php';</script>";
            } else {
