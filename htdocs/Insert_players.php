    ...
    <form method="post">
        ...
        if(isset($_POST['Insert1'])) {
            ...
            if(mysqli_num_rows($query) > 0) {
                ...
                $sql = "INSERT INTO Players (Player_id, Date_of_birth, Email, Contact_number , Last_name , First_name , Middle_name)
                 VALUES ('$player_id', '$Date_of_birth', '$Email', '$Contact_number', '$Last_name' , '$First_name' , '$Middle_name')";
                $query = mysqli_query($conn, $sql);
                if($query) {
